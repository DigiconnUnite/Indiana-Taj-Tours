...
<head>
    ...
    <title>
        Full Day Jaipur City Tour by Car | Indiana Taj Tour
    </title>
    <meta name="author" content="Indiana Taj Tour" />
    <meta name="description" content="Discover Jaipur's Pink City with a full day tour. Visit Amber Fort, City Palace, Hawa Mahal, and more with expert guides and comfortable transport." />
    <meta name="keywords" content="Jaipur city tour, Pink City tour, Amber Fort, City Palace, Jaipur sightseeing" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control" id="package" name="package" required>
                                                    ...
                                                    <option value="Full Day Jaipur City Tour by Car" selected>Full Day Jaipur City Tour by Car</option>
